...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void btnFireRadioEvent_Click(object sender, EventArgs e)
    {
        rdoGetMealVoucher_SelectedIndexChanged(null, null);
    }
            ...
            if (ds != null)
            {
                if (ds.Tables.Count > 0)
                {
                    ...
                    if (ds.Tables[1].Rows.Count > 0)
                    {
                        ...
                        rdoGetMealVoucher.SelectedValue = lblMealCardExisting.Text;

                        //if (Convert.ToInt32(rdoGetMealVoucher.SelectedValue) > 0)
                        //    lblMeamCardDeducFrmAA.Text = "-" + rdoGetMealVoucher.SelectedValue.ToString();
                        //End By Mohan
                        ...
                        //End By Chetna
                        //Added ByChetna on 16May22
                        dataRow = ds.Tables[1].AsEnumerable().Where(x => x.Field<string>("ComponentAbrev") == "CCA").FirstOrDefault();
                        lblCCAExisting.Text = dataRow["Emp_Component_Value"].ToString();
                        lblCCARestruct.Text = lblCCAExisting.Text;
                        //End By Chetna
                    ...
                    //Added by Chetna 09 Aug 22
                    lblGroupCTotalExisting.Text =
                  Convert.ToString(Convert.ToInt64(lblSiteAllowaExisting.Text == "" ? "0" : lblSiteAllowaExisting.Text) +
                  Convert.ToInt64(lblESICExisting.Text == "" ? "0" : lblESICExisting.Text) +
                  Convert.ToInt64(lblBonusExisting.Text == "" ? "0" : lblBonusExisting.Text)+
                  Convert.ToInt64(lblCCAExisting.Text == "" ? "0" : lblCCAExisting.Text));
                    //Ended by Chetna
                    ...
                    if (ds.Tables[4].Rows.Count > 0) //Get the employee Restructred CTC Data
                    {
                        ...
                        else if (lblGetMealVoucher.Text.Trim() == "Yes" && hdnIsNewEmployee.Value.Trim() == "No")
                        {
                            //lblMealCardRestruc.Text = "0";
                        ...
                        Int64 mobileDiff = Convert.ToInt64(lblMobileExisting.Text == "" ? "0" : lblMobileExisting.Text) -
                        ...
                        Convert.ToInt64(txtCHA.Text == "" ? "0" : txtCHA.Text) +
                        ...
                        Convert.ToInt64(lblNPSDeducFrmAA.Text == "" ? "0" : lblNPSDeducFrmAA.Text));
                        ...
                        Convert.ToInt64(lblESICRestruct.Text == "" ? "0" : lblESICRestruct.Text) +
                         Convert.ToInt64(lblBonusRestruct.Text == "" ? "0" : lblBonusRestruct.Text) +
                          Convert.ToInt64(lblCCARestruct.Text == "" ? "0" : lblCCARestruct.Text));
                        ...
                        if (hdnIsEmpFinalizedCTCRestruc.Value == "false")
                        {
                            ...
                            var MealCard = (Convert.ToInt64(lblMealCardExisting.Text.ToString()) - Convert.ToInt64(rdoGetMealVoucher.SelectedValue)).ToString();

                            var mobileVal = Convert.ToInt64(lblMobileExisting.Text) - Convert.ToInt64(txtMobile.Text);
                            ...
                            //Convert.ToInt64(lblMeamCardDeducFrmAA.Text == "" ? "0" : lblMeamCardDeducFrmAA.Text) -
                            //Convert.ToInt64(txtMobile.Text == "" ? "0" : txtMobile.Text) -
                            //Convert.ToInt64(txtNPSNewAmt.Text == "" ? "0" : txtNPSNewAmt.Text)); //Added By Chetna On 10 Aug 2022
                        ...
                        else
                        {
                            ...
                            //Convert.ToInt64(lblMeamCardDeducFrmAA.Text == "" ? "0" : lblMeamCardDeducFrmAA.Text) +                           
                            Convert.ToInt64(MealCard) +
                            Convert.ToInt64(lblNPSDeducFrmAA.Text == "" ? "0" : lblNPSDeducFrmAA.Text));//Added By Mohan On 30 May 2019
                        ...
                        hdnComputedCTCRestruct.Value = lblComputedCTCRestruct.Text;

                    }
                    else
                    {
                        if (hdnIsNewEmployee.Value.Trim() == "No")
                        {
                            lblMealCardRestruc.Text = rdoGetMealVoucher.SelectedValue.ToString();
                            lblMeamCardDeducFrmAA.Text = "-" + rdoGetMealVoucher.SelectedValue.ToString();
                        }
                        ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "PerformCalculation(); ", true);
                    }
    ...
    protected void btnApplyCTC_Click(object sender, EventArgs e)
     {
         try
         {
            ...
            lblMealCardRestruc.Text = Convert.ToInt64(rdoGetMealVoucher.SelectedValue).ToString();
            lblMeamCardDeducFrmAA.Text = (Convert.ToInt64(lblMealCardExisting.Text.ToString()) - Convert.ToInt64(rdoGetMealVoucher.SelectedValue)).ToString();
            ...
            //Added By Chetna on 9 Aug 2022
            dr = null;
            dr = dtComplete.NewRow();
            dr["EMPID1"] = lblEmpCode.Text;
            dr["Component_ID"] = "CCA";
            dr["Emp_Component_Value"] = lblCCARestruct.Text == "" ? "0" : lblCCARestruct.Text;
            dr["FinancialYear"] = hdnFinancialYearCurr.Value;
            dr["EmpGrade"] = lblGrade.Text;
            dtComplete.Rows.Add(dr);
            //Ended By Chetna
            ...
            //Int64 mAACalculation = 0;
            //string mealcard = "0";
            //string NPS = "0";
            //string SuperAnnuation = "0";
            //Int32 ExistingAA = 0;
            //Int32 mobile = 0;

            //mobile = txtMobile.Text == "" ? 0 : Convert.ToInt32(txtMobile.Text);
            ////lblMeamCardDeducFrmAA.Text
            //mealcard = lblMealCardRestruc.Text == "" ? "0" : lblMealCardRestruc.Text;
            //SuperAnnuation = lblAAWithSuperannuation.Text == "" ? "0" : lblAAWithSuperannuation.Text;
            
            //ExistingAA = lblAAExisting.Text == "" ? 0 : Convert.ToInt32(lblAAExisting.Text);
             ...
             if (ddlSuperanuation.SelectedValue == "3" || ddlSuperanuation.SelectedValue == "5")
             {
                 ...
                 //NPS = lblNPS.Text == "" ? 0 : Convert.ToInt32(lblNPS.Text);
             ...
             else
             {
                ...
                //NPS = txtNPSNewAmt.Text == "" ? 0 : Convert.ToInt32(txtNPSNewAmt.Text);
            ...
            //    {
            //        NPS = (Convert.ToInt64(lblNPSExistingAmt.Text) - Convert.ToInt64(txtNPSNewAmt.Text)).ToString();
            //    }
            //    else
            //    {
            //        NPS = "-" + (Convert.ToInt64(txtNPSNewAmt.Text) - Convert.ToInt64(lblNPSExistingAmt.Text)).ToString();
            //    }
            //}
            //else
            //{
            ...
            //mAACalculation = ExistingAA + Convert.ToInt32(SuperAnnuation) - mobile - Convert.ToInt32(mealcard) + Convert.ToInt64(NPS);
            ...
            //dr["Emp_Component_Value"] = mAACalculation;
            dr["FinancialYear"] = hdnFinancialYearCurr.Value;
            dr["EmpGrade"] = lblGrade.Text;
            dtComplete.Rows.Add(dr);
    ...
    private void calculateAA()
    {
        ...
        if (hdnIsNewEmployee.Value.Trim() == "Yes" && (hdnIsSAApplicable.Value.Trim() == "Yes" || hdnIsSAApplicable.Value.Trim() == "No"))
        {
            ...
            Int64 mobileDiff = Convert.ToInt64(lblMobileExisting.Text.ToString()) - Convert.ToInt64(txtMobile.Text.ToString());

            //lblAACalculation.Text =
            //  (Convert.ToInt64(txtAA.Text) +
            //   mobileDiff +
            //   Convert.ToInt64(lblAAWithSuperannuation.Text) -
            //   Convert.ToInt64(lblMeamCardDeducFrmAA.Text) +
            //   Convert.ToInt64(NPSAmt)).ToString();
    ...
    protected void rdoGetMealVoucher_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            Int64 NPSAmount = (txtNPSNewAmt.Text != "" ? Convert.ToInt64(txtNPSNewAmt.Text) : 0);
            string str1 = lblMealCardExisting.Text;
            hdnIsMealVoucherOpted.Value = rdoGetMealVoucher.SelectedValue ;
            //txtAA.Text = (Convert.ToInt64(lblMobileExisting.Text) + Convert.ToInt64(lblAAExisting.Text) - Convert.ToInt64(txtMobile.Text)).ToString();
