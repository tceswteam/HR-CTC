<%@ Page Debug="true" Language="C#" AutoEventWireup="true" CodeFile="frmEmpCTCRestruct_Version1_14Aug22.aspx.cs" Inherits="_Default" %>
...
<%--                        document.getElementById('<%=lblAACalculation.ClientID %>').innerHTML =
 ...
 <%--                        document.getElementById('<%=lblAACalculation.ClientID %>').innerHTML =
        ...
        lblGroupATotalRestruc = eval(lblBasicExisting) + (eval(txthra) + eval(txtCA) + eval(txtMARestruct) + eval(txtLTA) + eval(txtCEA) + eval(txtCHA)) + eval(document.getElementById('<%=txtMobile.ClientID%>').value) + eval(AA) + eval(lblAAWithCanteenSubsRestruc) + eval(lblAAWithSuperannuation) + eval(lblMeamCardDeducFrmAA) + eval(lblNPSDeducFrmAA);
        ...
        //alert(eval(AA));
                var OrigAA = eval(document.getElementById('<%=txtMobile.ClientID%>').value) -
                    eval(document.getElementById('<%=lblMobileExisting.ClientID%>').innerHTML) +
                    eval(document.getElementById('<%=lblAAExisting.ClientID%>').innerHTML);
        var NewAA = document.getElementById('<%=lblAACalculation.ClientID %>').innerHTML;
        ...
        if (eval(document.getElementById('<%=lblMobileExisting.ClientID%>').innerHTML) != eval(document.getElementById('<%=txtMobile.ClientID%>').value)) {
            var mobileVal = eval(document.getElementById('<%=txtMobile.ClientID%>').value) - eval(document.getElementById('<%=lblMobileExisting.ClientID%>').innerHTML);
                    ...
                    lblGroupATotalRestruc = (eval(lblBasicExisting) + (eval(txthra) + eval(txtCA) + eval(txtMARestruct) + eval(txtLTA) +
                        eval(txtCEA) + eval(txtCHA)) + eval(NewMobile1) + eval(OrigAA)) +
                ...
                lblGroupBTotalLimit = "0";
                    ...
                    lblGroupATotalRestruc = (eval(lblBasicExisting) + (eval(txthra) + eval(txtCA) + eval(txtMARestruct) + eval(txtLTA) +
                        eval(txtCEA) + eval(txtCHA)) + eval(OrigAA)) +
                        eval(lblAAWithSuperannuation) + eval(lblAAWithCanteenSubsRestruc) + eval(lblMeamCardDeducFrmAA) + eval(lblNPSDeducFrmAA) +
                        eval(NewMobile1);
          ...
          <%--  alert('1');
        alert(eval(document.getElementById('<%=txtMobile.ClientID%>').value));
        alert(eval(document.getElementById('<%=lblAAExisting.ClientID%>').innerHTML));
        alert(eval(document.getElementById('<%=lblMobileExisting.ClientID%>').innerHTML));--%>
      <%--      document.getElementById('<%=lblAA.ClientID%>').innerHTML = 
                        eval(document.getElementById('<%=lblMobileExisting.ClientID%>').innerHTML) +
                        eval(document.getElementById('<%=lblAAExisting.ClientID%>').innerHTML)  -
                        eval(document.getElementById('<%=txtMobile.ClientID%>').value);--%>

             document.getElementById('<%=txtAA.ClientID%>').innerHTML = eval(document.getElementById('<%=txtMobile.ClientID%>').value) -
                        eval(document.getElementById('<%=lblMobileExisting.ClientID%>').innerHTML) +
                        eval(document.getElementById('<%=lblAAExisting.ClientID%>').innerHTML) ;
        }
