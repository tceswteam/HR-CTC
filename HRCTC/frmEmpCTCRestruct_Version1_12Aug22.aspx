<%@ Page Debug="true" Language="C#" AutoEventWireup="true" CodeFile="frmEmpCTCRestruct_Version1_12Aug22.aspx.cs" Inherits="_Default" %>
...
function PerformCalculation() 
{
            if (document.getElementById('<%=hdnFormMode.ClientID%>').value == "0")//Form Mode 0 means new/Edit mode
            {
                ...
                if (eval(lblMedPre) == 0)
                {
                    document.getElementById('trMedPre').style.display = 'none';
                }
                else
                {
                    document.getElementById('trMedPre').style.display = 'block';
                }
                ...
                try {                  
                    ...
                    {
                        var mobileVal = eval(document.getElementById('<%=lblMobileExisting.ClientID%>').innerHTML) -
