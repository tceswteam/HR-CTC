...
public partial class _Default : System.Web.UI.Page
{
        ...
        try
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (Dset != null)
                {
                    ...
                    //ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('hi123'); ", true);
                    ...
                    //txtMARestruct.Attributes.Add("onkeyup", "Compare_Data(" + txtMARestruct.ClientID + "," + lblMAMaxCeiling.ClientID + ",event);");
    ...
    protected void PrepareActionButton()
    {
        ...
        else
        {
            ...
            btnPrintCTCRestruc0.Visible = false;
            lblEmpCTCRestrucStatus.Text = "You can restructure CTC for Financial Year:-" + hdnFinancialYearCurr.Value;
                ...
                if (ds.Tables.Count > 0)
                {
                    ...
                    if (ds.Tables[1].Rows.Count > 0)
                    {
                       ...
                       // lblAAWithCanteenSubsRestruc.Text = lblCanteenExisting.Text;
                        ...
                        dataRow = ds.Tables[1].AsEnumerable().Where(x => x.Field<string>("ComponentAbrev") == "SN_To_NPS").FirstOrDefault();
                        lblNPS.Text = dataRow["Emp_Component_Value"].ToString();
                        lblNPSExisting.Text = dataRow["Emp_Component_Value"].ToString();
                    ...
                    //Convert.ToInt64(lblNPSExisting.Text == "" ? "0" : lblNPSExisting.Text) +
                    ...
                    //lblComputedFixedExisting.Text = Convert.ToString((Convert.ToInt64(lblGroupATotalExisting.Text == "" ? "0" : lblGroupATotalExisting.Text) +
                    ...
                    //    Convert.ToInt64(lblCanteenExisting.Text == "" ? "0" : lblCanteenExisting.Text)) * 12);

                    lblTotalABCDExisting.Text =
                    Convert.ToString(
                    Convert.ToInt64(lblGroupATotalExisting.Text == "" ? "0" : lblGroupATotalExisting.Text) +
                    Convert.ToInt64(lblGroupBTotalExisting.Text == "" ? "0" : lblGroupBTotalExisting.Text) +
                    Convert.ToInt64(lblGroupCTotalExisting.Text == "" ? "0" : lblGroupCTotalExisting.Text) +
                    Convert.ToInt64(lblMealCardExisting.Text == "" ? "0" : lblMealCardExisting.Text));

                    lblComputedFixedExisting.Text = Convert.ToString((
                    Convert.ToInt64(lblTotalABCDExisting.Text == "" ? "0" : lblTotalABCDExisting.Text) * 12));

                    //lblTotalABCDExisting.Text =
                    //Convert.ToString(Convert.ToInt64(lblGroupATotalExisting.Text == "" ? "0" : lblGroupATotalExisting.Text) +
                    //Convert.ToInt64(lblGroupBTotalExisting.Text == "" ? "0" : lblGroupBTotalExisting.Text) +
                    //Convert.ToInt64(lblGroupCTotalExisting.Text == "" ? "0" : lblGroupCTotalExisting.Text) +
                    //Convert.ToInt64(lblCanteenExisting.Text == "" ? "0" : lblCanteenExisting.Text)
                    //);
                    ...
                    //txtMARestruct.Enabled = false;// make medical allowance disabled //Again Making it enable
                    ...
                    if (ds.Tables[4].Rows.Count > 0) //Get the employee Restructred CTC Data
                    {
                        ...
                        lblComputedFixedRestructur.Text = Convert.ToString((Convert.ToInt64(lblGroupATotalRestruc.Text == "" ? "0" : lblGroupATotalRestruc.Text) +
                        ...
                        lblComputedCTCRestruct.Text = Convert.ToString((Convert.ToInt64(lblComputedFixedRestructur.Text == "" ? "0" : lblComputedFixedRestructur.Text) +
                        ...
                        else
                        {
                            ...
                            //    //  Convert.ToInt64(lblAAWithCanteenSubsRestruc.Text == "" ? "0" : lblAAWithCanteenSubsRestruc.Text) +
                            //      Convert.ToInt64(lblAAWithSuperannuation.Text == "" ? "0" : lblAAWithSuperannuation.Text) -
                            //      Convert.ToInt64(lblCanteenRestruct.Text == "" ? "0" : lblCanteenRestruct.Text) -
    ...
    {
        ////if (ddlSuperanuation.SelectedItem.Text == "Amount above 1L per annum can be transferred to NPS")
        //if (ddlSuperanuation.SelectedValue == "4")
        //{
        //    ClientScriptManager cs = Page.ClientScript;
        //    lblSNRestruct.Text = Convert.ToInt64(100000 / 12).ToString();
        //    lblNPS.Text = ((((Convert.ToInt64(lblBasicExisting.Text) * 15 / 100) * 12) - 100000)/12).ToString();
        //    lblSNRestruct.Text = Convert.ToInt64(100000 / 12).ToString();
        //    lblAAWithSuperannuation.Text = "0";
        //    if (Convert.ToInt64(lblSNExisting.Text) !=( Convert.ToInt64(lblAAWithSuperannuation.Text) + Convert.ToInt64(lblSNRestruct.Text) + Convert.ToInt64(lblNPS.Text)))
        //    {
        //        lblSNRestruct.Text =(Convert.ToInt64( lblSNRestruct.Text )+ Convert.ToInt64(lblSNExisting.Text) - (Convert.ToInt64(lblAAWithSuperannuation.Text) + Convert.ToInt64(lblSNRestruct.Text) + Convert.ToInt64(lblNPS.Text))).ToString();
        //    }
        //    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "OnSelectionOfNoChangeInSuperanuation123('4');", true);
        //    //ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "document.getElementById('trSuperAnnuation').style.display='block';document.getElementById('trSuperAnnuation').style.width='100%';  document.getElementById('trNPS').style.display='block';document.getElementById('trNPS').style.width='100%';PerformCalculation();", true);
                        
        //}
        ////else if (ddlSuperanuation.SelectedItem.Text == "Amount above 1L per annum can be transferred to AA")
        //else if (ddlSuperanuation.SelectedValue == "3")
        //{
        //    ClientScriptManager cs = Page.ClientScript;
        //    lblAASuperAnuationOption.Text = "Addition Superanuation Merged With AA";
        //    lblAAWithSuperannuation.Text = ((((Convert.ToInt64(lblBasicExisting.Text) * 15 / 100) * 12) - 100000) / 12).ToString();
        //    lblNPS.Text = "0";
        //    lblSNRestruct.Text =Convert.ToInt64( 100000/12).ToString();
        //    if (Convert.ToInt64(lblSNExisting.Text) != (Convert.ToInt64(lblAAWithSuperannuation.Text) + Convert.ToInt64(lblSNRestruct.Text) + Convert.ToInt64(lblNPS.Text)))
        //    {
        //        lblSNRestruct.Text = (Convert.ToInt64(lblSNRestruct.Text) + Convert.ToInt64(lblSNExisting.Text) - (Convert.ToInt64(lblAAWithSuperannuation.Text) + Convert.ToInt64(lblSNRestruct.Text) + Convert.ToInt64(lblNPS.Text))).ToString();
        //    }
        //    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "OnSelectionOfNoChangeInSuperanuation123('3');", true);
        //    //ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", " document.getElementById('trSuperAnnuation').style.display='block';document.getElementById('trSuperAnnuation').style.width='100%'; document.getElementById('trSuperanuationMerged').style.display='block';document.getElementById('trSuperanuationMerged').style.width='100%';PerformCalculation();", true);

        //}
        ////else if (ddlSuperanuation.SelectedItem.Text == "Whole SA amount can be merged in AA")
        //else if (ddlSuperanuation.SelectedValue == "2")
        //{
        //    lblAASuperAnuationOption.Text = "Whole Superanuation Merged with AA";
        //    lblAAWithSuperannuation.Text = lblSNExisting.Text;
        //    lblSNRestruct.Text = "0";

        //    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "OnSelectionOfNoChangeInSuperanuation123('2');", true);      
        //}
        ////else if (ddlSuperanuation.SelectedItem.Text == "No change")
        //else if (ddlSuperanuation.SelectedValue == "1")
        //{
        //    lblSNRestruct.Text = lblSNExisting.Text;
        //    lblAAWithSuperannuation.Text = "0";
        //    lblNPS.Text = "0";
        //    lblAAWithSuperannuation.Text = "0";
        //    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "OnSelectionOfNoChangeInSuperanuation123('1');", true);      
        //}
    }
    ...
    //    ddlFinancialYear.DataSource = mDSet.Tables[7];
    //    ddlFinancialYear.DataTextField = "Text";
    //    ddlFinancialYear.DataValueField = "Value";
    //    ddlFinancialYear.DataBind();

    //    // this.Doc.YRKey = mDSet.Tables[0].Rows[0]["MonYear"].ToString();
    //    //hdnFinancialYear.Value = mDSet.Tables[0].Rows[0]["FinancialYear"].ToString();
    ...
    protected void btnApplyCTC_Click(object sender, EventArgs e)
     {
         try
         {
             ...
             if (empRestructCTCTotal != empBaseCTCTotal || txtGroupALabel.Text != "0" || lblGroupBTotalLimit.Text != "0"  )
             {
             ...
             //lblAACalculation.Text = (Convert.ToInt64(txtAA.Text) + Convert.ToInt64(lblMobileExisting.Text) + Convert.ToInt64(lblAAWithSuperannuation.Text) - Convert.ToInt64(rdoGetMealVoucher.SelectedValue)).ToString();
             ...
             dr["EMPID1"] = lblEmpCode.Text;
             dr["Component_ID"] = "SN";
             dr["Emp_Component_Value"] = lblSNExisting.Text == "" ? "0" : lblSNExisting.Text;
             dr["FinancialYear"] = hdnFinancialYearCurr.Value;
             dr["EmpGrade"] = lblGrade.Text;
             dtComplete.Rows.Add(dr);
             //}
             ...
             try
             {
                 ...
                 mDbCommand.Parameters.AddWithValue("@SuperanuationOption", SqlDbType.VarChar).Value = "";
                                  
                 mDbCommand.ExecuteNonQuery();
                 Response.Redirect("DummyVersion1.aspx", false);
                 mDSet = null;
                 mDSet = new DataSet();
                 hdnIsEmpFinalizedCTCRestruc.Value = "false";
                 mDSet = GetEmployeeBaseCTC();
