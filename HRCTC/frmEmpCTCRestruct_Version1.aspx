...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function PerformCalculation() {
            ...
            mobile = (document.getElementById('<%=txtMobile.ClientID %>').innerHTML == "") ? "0" : document.getElementById('<%=txtMobile.ClientID %>').innerHTML;
            try {
...
<%--                        document.getElementById('<%=lblAACalculation.ClientID %>').innerHTML =
 ...
 <%--                        document.getElementById('<%=lblAACalculation.ClientID %>').innerHTML =
                ...
                alert(eval(document.getElementById('<%=lblMeamCardDeducFrmAA.ClientID%>').innerHTML));
                        ...
                        document.getElementById('<%=lblAACalculation.ClientID %>').innerHTML =
                            eval(document.getElementById('<%=lblAAExisting.ClientID %>').innerHTML) + mobileVal +
                            eval(document.getElementById('<%=lblNPSDeducFrmAA.ClientID%>').innerHTML);
                    }
                    else if (document.getElementById('<%=hdnIsNewEmployee.ClientID%>').value.trim() == "No"
                        && document.getElementById('<%=hdnIsSAApplicable.ClientID%>').value.trim() == "Yes") {
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <ol type="1" style="font-family: Verdana; font-size: 12px;">
                            ...
                            <li>The compensation restructuring will be effective 1st August 2022 for existing employees (with date of Joining till 31st March 2022).<strong> CompStruct will be open till 17th August 2022 for existing employees.</strong> Employees will be required to restructure and submit restructured CTC online by 17th August 2022. <strong>In case, an employee does not submit the restructured CTC by 17th August 2022, prevailing CTC will continue for the rest of the Financial Year.
                            ...
                            <li>“Mobile Reimbursement” and “Meal Card” can be restructured with Additional Allowance (AA).</li>
