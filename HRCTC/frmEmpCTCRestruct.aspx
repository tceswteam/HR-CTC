<%@ Page Debug="true" Language="C#" AutoEventWireup="true" CodeFile="frmEmpCTCRestruct.aspx.cs" Inherits="_Default" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function CheckForValueRangeCA(minRange, currentvalue, valueoffield) {
            //alert('hi');
            var minval = minRange;
            // alert(document.getElementById(currentvalue.id).value);
            var currentval = eval(document.getElementById(currentvalue.id).value);
            // alert(eval(currentval) + ' ' + eval(minRange) + ' ' + eval(maxRange));
            //if (eval(currentvalue) < eval(minRange) || eval(currentvalue) > eval(maxRange))
            if (currentval == "")
        ...
        function OnNPSValueEnter() {
            ...
            //End By Mohan
            //Added By Mohan On 27 May 2019
            document.getElementById('<%=txtAASA.ClientID%>').innerHTML = eval(BalanceForTransfer);
            //End By Mohan
        }

        //Commented By Mohan On 29 May 2019
       <%-- function CheckForSATransferNPS(Compare1) {
            // alert(document.getElementById('Compare1.id').value);
            if ((eval(document.getElementById('<%=txtNPSSA.ClientID%>').value)) != 0) {
                if ((eval(document.getElementById('<%=txtNPSSA.ClientID%>').value)) < 500) {
                    alert("Value in NPS can either be zero or more than Rs. 499/- per month.");
                    document.getElementById('<%=txtNPSSA.ClientID%>').value = "0";
                    OnNPSValueEnter();
                    //document.getElementById('<%=txtNPSSA.ClientID%>').focus();
                    return false;
                }
            }
            var BalanceForTransfer;
            ...
            if (eval(document.getElementById('<%=txtNPSSA.ClientID%>').value) > eval(BalanceForTransfer)) {
                alert("Maximum NPS can be the less than or equal to Balance to transfer." + BalanceForTransfer);
                document.getElementById('<%=txtNPSSA.ClientID%>').value = "0";
                OnNPSValueEnter();
                //document.getElementById('<%=txtNPSSA.ClientID%>').focus();
                return false;
        ...
        function CheckForSATransferAA(Compare1) {
            //alert(document.getElementById('Compare1.id').value);
            var BalanceForTransfer;
            var NPSval;
            var AANew
            BalanceForTransfer = document.getElementById('<%=hdnBalnceSA.ClientID%>').value;
           <%-- Commented By Mohan On 27 May 2019
            document.getElementById('<%=txtNPSSA.ClientID%>').value = eval(BalanceForTransfer) - eval(document.getElementById('<%=txtAASA.ClientID%>').innerHTML);
            End By Mohan--%>
        }

        function CheckForMobileAmount() {
            ...
            //document.getElementById('<%=txtAA.ClientID %>').innerHTML = (eval(lblMobileExisting) + eval(lblAAExisting) + eval(lblAAWithCanteenSubsRestruc)) - (eval(mobile));          
        ...
        function OnSelectionOfNoChangeInSuperanuation123(id) {
            ...
            if (listBoxSelectonValue == "-1") {
                ...
                document.getElementById('<%=lblSNRestruct.ClientID %>').innerHTML = document.getElementById('<%=lblSNExisting.ClientID %>').innerHTML;
               ...
               <%-- document.getElementById('<%=lblNPS.ClientID%>').innerHTML = "0";--%>
                ...
                document.getElementById('<%=hdnBalnceSA.ClientID%>').value = basic_15perc - basic_5perc;
                document.getElementById('<%=lblSAOLD.ClientID %>').innerHTML = basic_15perc;
                ...
                //Added By mohan On 27 May 2019
                document.getElementById('<%=txtAASA.ClientID%>').innerHTML = document.getElementById('<%=hdnBalnceSA.ClientID%>').value;   
                //End By Mohan
                ...
                document.getElementById('<%=hdnBalnceSA.ClientID%>').value = basic_15perc - basic_10perc;
                document.getElementById('<%=lblSAOLD.ClientID %>').innerHTML = basic_15perc;
...
function PerformCalculation() {
    ...
    var lblBasicExisting = (document.getElementById('<%=lblBasicExisting.ClientID %>').innerHTML == "") ? "0" : document.getElementById('<%=lblBasicExisting.ClientID %>').innerHTML;
            ...
            var txtGroupALabel = (eval(lblGroupALevEncMax) - (eval(txthra) + eval(txtCA) + eval(txtMARestruct) + eval(txtLTA) + eval(txtCEA) + eval(txtCHA)));
            document.getElementById('<%=txtGroupALabel.ClientID %>').value = txtGroupALabel;
        ...
        <%--    var IsMealVoucherOpted = document.getElementById('<%=hdnIsMealVoucherOpted.ClientID %>').value;
            ...
            if (isCTCFinalized == 'true') {
                ...
                lblGroupATotalRestruc = eval(lblBasicExisting) + (eval(txthra) + eval(txtCA) + eval(txtMARestruct) + eval(txtLTA) + eval(txtCEA) + eval(txtCHA)) + eval(mobile) + eval(AA);
                //lblGroupATotalRestruc = eval(lblBasicExisting) + (eval(txthra) + eval(txtCA) + eval(txtMARestruct) + eval(txtLTA) + eval(txtCEA) + eval(txtCHA)) + eval(mobile) + eval(AA) + eval(lblAAWithCanteenSubsRestruc) + eval(lblAAWithSuperannuation) + eval(lblMeamCardDeducFrmAA);
                ...
                //lblGroupATotalRestruc = (eval(lblBasicExisting) + (eval(txthra) + eval(txtCA) + eval(txtMARestruct) + eval(txtLTA) + eval(txtCEA) + eval(txtCHA))+ eval(AA));
                //lblGroupATotalRestruc = (eval(lblBasicExisting) + (eval(txthra) + eval(txtCA) + eval(txtMARestruct) + eval(txtLTA) + eval(txtCEA) + eval(txtCHA)) + eval(mobile) + eval(AA));
            }
            //alert(lblGroupATotalRestruc);
            ...
            var lblMealCard = (document.getElementById('<%=lblMealCardExisting.ClientID%>').innerHTML == "") ? "0" : document.getElementById('<%=lblMealCardExisting.ClientID %>').innerHTML;
			//Added By Mohan on 27 May 2019 
            var txtNewNPS;
            if (isCTCFinalized == 'true') {
            ...
            var lblGroupCTotalRestruc = eval(lblSiteAllowaRestruct) + eval(lblESICRestruct);
            document.getElementById('<%=lblGroupCTotalRestruc.ClientID %>').innerHTML = lblGroupCTotalRestruc;

            var lblCanteenRestruct = "0";
            ...
            var lblTotalABCDRestruc = eval(lblMealCard) + eval(lblGroupCTotalRestruc) + eval(lblGroupBTotalRestruc) + eval(lblGroupATotalRestruc);
            //var lblTotalABCDRestruc = eval(lblCanteenRestruct) + eval(lblGroupCTotalRestruc) + eval(lblGroupBTotalRestruc) + eval(lblGroupATotalRestruc);

            document.getElementById('<%=lblTotalABCDRestruc.ClientID %>').innerHTML = lblTotalABCDRestruc;

            var lblComputedFixedRestructur = (eval(lblGroupCTotalRestruc) + eval(lblGroupBTotalRestruc) + eval(lblGroupATotalRestruc) + eval(lblMealCard)) * 12;
            //var lblComputedFixedRestructur = (eval(lblCanteenRestruct) + eval(lblGroupCTotalRestruc) + eval(lblGroupBTotalRestruc) + eval(lblGroupATotalRestruc)) * 12;
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <ol type="1" style="font-family: Verdana; font-size: 12px;">
                            ...
                            <li>Please refer to <a href="Documents/M9HR36AR4 - Compensation Restructuring_User Manual.pdf" target="_blank">TCE.M9-HR-PA-36A : Compensation Restructuring (CompStruct) – User Manual.pdf” </a>before restructuring your CTC.</li>
                            <li>The compensation restructuring will be effective 1st April 2018 for existing employees (with date of Joining till 31st March 2018). <strong>CompStruct will be open till 19th June 2018 for existing employees. </strong>Employees will be required to restructure and submit restructured CTC online by 19th June 2018. <strong>In case, an employee does not submit the restructured CTC by 19th June 2018, prevailing CTC will continue for the rest of the Financial Year. </strong></li>
                            <li>For new joinees (Date of Joining 1st April 2018 onwards), Compensation restructuring will be as per timelines mentioned in TCE.M9-HR-PA-36A. In case, an employee does not submit the restructured CTC, prevailing CTC will continue for the rest of the Financial Year. </li>
                            <li>Employees are requested to understand prevailing income tax rules before restructuring compensation suiting to their individual needs. Once the restructured compensation is submitted, it will continue for the rest of the Financial Year. No modification will be permitted after submission. </li>
                            <li>The amount in HRA, CA, LTA, CEA and MA can be restructured within these components only, as these components are used for leave encashment. Since Additional Allowance (AA) is not a leave encashment component, the newly introduced components “Mobile Reimbursement” and “Meal Card” can be restructured with AA only.  </li>
                            ...
                            <li>The amount in Superannuation can be restructured with AA or NPS (Applicable to E6/A6/T6 & above grades only). If you choose to invest in NPS, you must open corporate NPS account and submit relevant details to your DC-HR before 15th of the month. </li>
            ...
            <table id="rcorners6">
                ...
                <tr>
                    ...
                    <td rowspan="6" style="background-image: url('Layout/Images/GroupAImg_New.png'); background-repeat: no-repeat;">
                        <asp:TextBox ID="txtGroupALabel" runat="server" CssClass="numerictextboxlabel" TabIndex="1000"
                ...
                <tr>
                    ...
                    <td class="form-fld-lbl">
                        <div id="1233" class="container">
                            <asp:ImageButton ID="trigger1" runat="server" onmouseover1="HideAndShowHelpDiv('1');" Visible="false" ImageUrl="~/Layout/Images/help_16x16.ico" />
                            <div id="pop-up1">
                ...
                <tr>
                    ...
                    <td class="form-fld-lbl" style="background-color: white;">
                        <asp:TextBox ID="txtMARestruct" runat="server" CssClass="numerictextboxlabel" onblur="javascript:IsNumeric(this,event);" Width="92%">0</asp:TextBox>
                    ...
                    <td class="form-fld-lbl">
                        <div id="1237" class="container">
                            <asp:ImageButton ID="trigger4" runat="server" Visible="false" ImageUrl="~/Layout/Images/help_16x16.ico" Style="width: 16px" />
                            <div id="pop-up4">
                ...
                <tr id="trMobile">
                    ...
                    <td rowspan="2">
                        <asp:Label ID="lblGroupBTotalLimit" runat="server" Text="0" CssClass="numerictextboxlabel" Visible="false" Width="55px"></asp:Label><br />
                    </td>
                    <td class="form-fld-lbl" style="background-color: white;">
                ...
                <%-- <tr>
                    <td class="form-fld-lbl"></td>
                    <td class="form-fld-lbl">Amt. added from Canteen Subsidy to AA 
                        </td>
                    <td class="form-fld-lbl" style="background-color: white;">
                        <asp:Label ID="lblAAWithCanteenSubsExisting" runat="server" CssClass="numerictextboxlabel" Width="92%"></asp:Label>
                    </td>
                    <td class="form-fld-lbl" style="background-color: white;">
                        <asp:Label ID="lblAAWithCanteenSubsRestruc" runat="server" Width="92%" CssClass="numerictextboxlabel">0</asp:Label>
                    </td>
                    <td class="form-fld-lbl" >
                        &nbsp;</td>
                    <td></td>
                    ...
                    <td class="form-fld-lbl">
                        <div id="12310" class="container">
                            ...
                            <div id="pop-up10">
                                ...
                                <p>
                                    Currently applicable to E6/A6/T6 & above grades and is 15% of Basic.
                                </p>
                                <p>
                                    As per current IT rules, tax exemption limit for contribution by employer to SN fund is Rs 1.5 lakh per annum. Employee may choose to divert SN amount excess to Rs. 1.5 L per annum to NPS for additional tax benefits. 
Employee can avail tax exemption upto 10% of basic salary towards employer contribution in NPS.
                                </p>
                                <p>TCE’s Superannuation deed with LIC is now revised to allow restructuring of SN amount to</p>
                                <p>•	NPS to avail additional tax benefits OR </p>
                                <p>•	AA to increase take home salary OR</p>
                                <p>•	NPS and AA to avail both the benefits as above</p>
                                <p>As per revised deed, employees having SN in CTC can choose to SN amount to be –</p>
                                <p>•	15% of Basic (no change from current amount) OR</p>
                                <p>•	10% of Basic OR</p>
                                <p>•	5% of Basic </p>
                                <p>
                                    Employee will get the above option to choose % of Basic as SN once in tenure in TCE. e.g. if the employee chooses 10% of Basic as SN, it will remain 10% of Basic throughout his/ her tenure in TCE. 
In case employee chooses SN to be 5% or 10% of Basic, the differential amount between current SN (15% of Basic) and revised SN will need to be diverted to National Pension Scheme (NPS) and/or AA.
                                </p>

                                <p>Employee has flexibility to decide his/her contribution in NPS and AA. However, employees must note – </p>
                                <p>•	Once the % of Basic to be contributed to Superannuation is reduced, this percentage will continue to be the same throughout tenure in TCE. This will reduce their future contribution towards Superannuation corpus.</p>
                                <p>•	Amount diverted in AA will increase monthly gross salary but at the same time it will be taxable.</p>
                            </div>
                        </div>
                    </td>
                </tr>
                        ...
                        <div id="trNPSNew" style="width: 100%; background-color: #d3d6ed;">
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <td class="form-fld-lbl" style="background-color: white; width: 8.5%">
                                        <asp:TextBox ID="txtNPSNewAmt" runat="server" Width="95%" onblur="javascript:IsNumeric(this,event);" CssClass="numerictextboxlabel"></asp:TextBox>
                        ...
                        <asp:Panel ID="pnlPopup" runat="server" CssClass="modalPopup" Style="display: none">
                            ...
                            <div class="body">
                                <table width="100%">
                                    ...
                                    <tr>
                                        <td class="form-fld-lbl" style="text-align: left">Transfer to AA Rs.</td>
                                        <td>:</td>
                                        <td class="form-fld-lbl">
                                            <asp:Label ID="txtAASA" runat="server" Width="100px" class="numerictextboxlabel">0</asp:Label>
                                        </td>
                                    </tr>
                                </table>
                                <br />
        ...
        <asp:HiddenField ID="hdnEmpRestructuredCTCRetruct" runat="server" />
        <br />
        ...
        <asp:HiddenField ID="hdntxtMobile" runat="server" />
