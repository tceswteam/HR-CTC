<%@ Page Debug="true" Language="C#" AutoEventWireup="true" CodeFile="frmEmpCTCRestruct_Version1_7Jun22.aspx.cs" Inherits="_Default" %>
            ...
            for (var i = 0; i < radio.length; i++)
            {
                if (radio[i].checked) {
                    document.getElementById('<%=txtAA.ClientID %>').innerHTML = (eval(lblMobileExisting) + eval(lblAAExisting)) - (eval(mobile));
                        ...
                        document.getElementById('<%=lblAACalculation.ClientID %>').innerHTML = eval(document.getElementById('<%=lblAAExisting.ClientID %>').innerHTML) + eval(lblMobileExisting) + eval(lblAAWithCanteenSubsRestruc) + eval(lblAAWithSuperannuation) - eval(radio[i].value);
                    }
                }
                PerformCalculation();
        }
...
function PerformCalculation() 
{
    ...
    //End by Chetna 16 May 22
            ...
            if (isCTCFinalized == 'true') {
                ...
                lblGroupATotalRestruc = eval(lblBasicExisting) + (eval(txthra) + eval(txtCA) + eval(txtMARestruct) + eval(txtLTA) + eval(txtCEA) + eval(txtCHA)) + eval(mobile) + eval(AA) + eval(lblAAWithCanteenSubsRestruc) + eval(lblAAWithSuperannuation) + eval(lblMeamCardDeducFrmAA) + eval(lblNPSDeducFrmAA);
                lblGroupBTotalLimit = (eval(lblMobileExisting) + eval(lblAAExisting)) - (eval(mobile) + eval(AA));
                ...
                lblGroupATotalRestruc = (eval(lblBasicExisting) + (eval(txthra) + eval(txtCA) + eval(txtMARestruct) + eval(txtLTA) + eval(txtCEA) + eval(txtCHA)) + eval(mobile) + eval(AA)) + eval(lblAAWithSuperannuation) + eval(lblAAWithCanteenSubsRestruc) + eval(lblMeamCardDeducFrmAA) + eval(lblNPSDeducFrmAA);;
                lblGroupBTotalLimit = (eval(lblMobileExisting) + eval(lblAAExisting)) - (eval(mobile) + eval(AA));
            }
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <ol type="1" style="font-family: Verdana; font-size: 12px;">
                            ...
                            <li>Please refer to <a href="Documents/M9HR36AR6 - Compensation Restructuring (CompStruct)_User Manual.pdf" target="_blank">TCE.M9-HR-PA-36A : Compensation Restructuring (CompStruct) – User Manual.pdf” </a>before restructuring your CTC.</li>
            ...
            <table style="margin: 0px auto; width: 70%; text-align: center;">
                <tr>
                    <td>
                        ...
                        <asp:ImageButton ID="btnPrintFinal" Text="Print" runat="server" ImageUrl="~/Layout/Images/Save File.png" OnClick="btnPrintFinal_Click1" ForeColor="white" Height="25px" Width="94px" />
